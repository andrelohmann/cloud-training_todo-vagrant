...
Vagrant.configure(2) do |config|
  ...
  config.trigger.before :up do |trigger|
    trigger.info = "Cloning working repositories..."
  ...
  config.vm.synced_folder "application", "/var/www/html", create: true, owner: "vagrant", group: "www-data", mount_options: ["dmode=775,fmode=775"]
